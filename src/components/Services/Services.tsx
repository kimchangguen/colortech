...
const services = [
  {
    id: '01',
    title: '기업 맞춤 컨설팅',
    description: '기업의 규모와 업무환경을 분석하여\n복합기, 프린터, 스캐너 등\n가장 효율적인 장비를 제안합니다.',
    image: '/images/service_new_01.png',
  },
  {
    id: '02',
    title: '신속한 설치 · 유지관리',
    description: '전문 엔지니어가\n설치부터 초기 세팅까지 진행하며\n\n정기점검과 유지보수로\n안정적인 업무환경을 제공합니다.',
    image: '/images/service_new_02.png',
  },
  {
    id: '03',
    title: '실시간 기술지원',
    description: '장비 장애 발생 시\n원격지원과 현장출동을 통해\n\n업무 중단 시간을\n최소화합니다.',
    image: '/images/service_new_03.png',
  },
];
  ...
  return (
    <section className="py-24 md:py-32 bg-[#F8F9FB]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[28px] lg:gap-[32px]">
          {services.map((service) => (
            <div 
              key={service.id}
              className="group bg-white rounded-[24px] overflow-hidden border border-transparent shadow-sm hover:shadow-2xl hover:-translate-y-2 hover:border-[#111111] transition-all duration-[350ms] ease-out cursor-pointer flex flex-col"
            >
              {/* Content Container (Top) */}
              <div className="p-[32px] flex-grow flex flex-col relative z-10 bg-white">
              ...
              <div className="relative w-full h-[220px] overflow-hidden rounded-b-[24px] bg-gray-100">
                <Image 
                  src={service.image} 
                  alt={service.title}
                  fill
